...
def dialog_about(fNameNoSuf, question, params=params):
    ...
    if isinstance(question, list):
        for q in question:
            say(q)
            process_quest(q, M, gm, qgm, fNameNoSuf, log, params=params)
    elif question:
        say(question)
        print('')
        dialog_step(question, gm, qgm, fNameNoSuf, log, params=params)
    else:
        while True:
            question = input('?-- ')
            if not question: break
            process_quest(question, M, gm, qgm, fNameNoSuf, log, params=params)
...
def process_quest(question, M, gm, qgm, fNameNoSuf, log, params=params):
    question = question + ' '
    if question in M:
        i = M.index(question)
        M.pop(i)
...
def dialog_step(question, gm, qgm, fNameNoSuf, log, params=params):
